 ...
 */
@Entity
@Table(name = "vw_rp_cost_account", schema = "")
@SuppressWarnings("serial")
public class VwRpCostAccountEntity implements java.io.Serializable {
	/**id*/
	...
	@Column(name ="PROJ_MAN_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="MAX_BC_INVOICE_DATE",nullable=true)
	...
	@Column(name ="INV_BACK_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="MAX_BC_COL_DATE",nullable=true)
	...
	@Column(name ="BRP_BACK_AMOUNT_D",nullable=true,length=32)
	...
	@Column(name ="RECEIVABLE_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="NOT_RECEIVABLE_PER",nullable=true,length=32)
	...
	@Column(name ="PO_PAYABLE_TAMOUNT",nullable=true,length=32)
	...
	@Column(name ="PO_PAY_TAMOUNT",nullable=true,length=32)
	...
	@Column(name ="PO_NOT_PAY_TAMOUNT",nullable=true,length=32)
	...
	@Column(name ="OTHERS_PAY_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="PROJ_PAY_TOTAL",nullable=true,length=32)
	...
	@Column(name ="PAD_BRANCH_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="PAD_BRANCH_COST",nullable=true,length=32)
	...
	@Column(name ="CASH_MARGIN_AMOUNT",nullable=true,length=32)
	...
	@Column(name ="PAYABLE_MARGIN_AMOUNT",nullable=true,length=32)
