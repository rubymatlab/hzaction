 ...
 */
@Entity
@Table(name = "vm_merge_bus_po_apply_detail", schema = "")
@SuppressWarnings("serial")
public class VmMergeBusPoApplyDetailEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String bpadNumber;
	/**备注*/
	...
	@Column(name ="BPAD_NAME",nullable=true,length=32)
	...
	@Column(name ="BPAD_BRAND",nullable=true,length=32)
	...
	@Column(name ="BPAD_MODEL",nullable=true,length=32)
	...
	@Column(name ="BPAD_NUMBER",nullable=true,length=32)
	public java.lang.String getBpadNumber(){
	 ...
	 */
	public void setBpadNumber(java.lang.String bpadNumber){
	...
	@Column(name ="BPAD_REMARK",nullable=true,length=32)
