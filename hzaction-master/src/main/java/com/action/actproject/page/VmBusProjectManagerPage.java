...
package com.action.actproject.page;
 ...
 *
 */
public class VmBusProjectManagerPage implements java.io.Serializable {
	/**id*/
	...
	/**保存-回款计划*/
    @ExcelCollection(name="回款计划")
	private List<VmBusCollectPlanEntity> vmBusCollectPlanList = new ArrayList<VmBusCollectPlanEntity>();
		public List<VmBusCollectPlanEntity> getVmBusCollectPlanList() {
		return vmBusCollectPlanList;
		}
		public void setVmBusCollectPlanList(List<VmBusCollectPlanEntity> vmBusCollectPlanList) {
		this.vmBusCollectPlanList = vmBusCollectPlanList;
		}
//		@ExcelCollection(name="回款计划")
//		private List<VmBusCollectPlanEntity> vmBusCollectPlanList = new ArrayList<VmBusCollectPlanEntity>();
//			public List<VmBusCollectPlanEntity> getVmBusCollectPlanList() {
...
//			}
	/**保存-项目跟进*/
    @ExcelCollection(name="项目跟进")
	private List<BusProjectFollowEntity_manager> busProjectFollowList = new ArrayList<BusProjectFollowEntity_manager>();
		public List<BusProjectFollowEntity_manager> getBusProjectFollowList() {
		return busProjectFollowList;
		}
		public void setBusProjectFollowList(List<BusProjectFollowEntity_manager> busProjectFollowList) {
