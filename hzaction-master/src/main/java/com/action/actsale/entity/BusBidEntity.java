 ...
 * @date 2019-07-30 17:13:56
 * @version V1.0   
 *
 */
@Entity
@Table(name = "bus_bid", schema = "")
@SuppressWarnings("serial")
public class BusBidEntity implements java.io.Serializable {
	/**主键*/
...
//	@Excel(name="客户资料外键",width=15)
	...
	@Column(name ="BD_PROJ_TYPE",nullable=false,length=20)
