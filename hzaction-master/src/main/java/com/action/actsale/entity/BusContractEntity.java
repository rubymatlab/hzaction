...
public class BusContractEntity implements java.io.Serializable {
	...
	/**客户名称*/
	@Excel(name="客户名称",width=15,dictTable ="bus_contract",dicCode ="bc_customer_name",dicText ="bc_customer_name")
	...
	@Column(name ="BC_CONT_START_TIME",nullable=true,length=32)
	...
	@Column(name ="BC_CONT_END_TIME",nullable=true,length=32)
