...
public class VwBusProjectEntity implements java.io.Serializable {
	...
	/**正式挂网时间*/
	@Excel(name="正式挂网时间",width=15,format = "yyyy-MM-dd")
	...
	@Column(name ="BP_PRO_ID",nullable=true,length=32)
	...
	@Column(name ="BP_PRO_NAME",nullable=true,length=50)
	...
	@Column(name ="BP_KEY_PEOPLE",nullable=true,length=50)
	...
	@Column(name ="BP_TEAM",nullable=true,length=32)
	...
	@Column(name ="BP_FOLLOW_RESULTS",nullable=true,length=32)
