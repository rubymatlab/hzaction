...
public class BusContractPage implements java.io.Serializable {
	...
	public String toString() {
		return "BusContractPage [id=" + id + ", createName=" + createName + ", createBy=" + createBy + ", createDate="
				...
				+ ", bcCustomerCode=" + bcCustomerCode + ", bcCustomerName=" + bcCustomerName + ", bcProjectCode="
				+ bcProjectCode + ", bcContractName=" + bcContractName + ", bcCustContractor=" + bcCustContractor
				+ ", bcCompContractor=" + bcCompContractor + ", bcConcludeTime=" + bcConcludeTime + ", bcContStartTime="
				+ bcContStartTime + ", bcContEndTime=" + bcContEndTime + ", bcContAmount=" + bcContAmount
				+ ", bcContractState=" + bcContractState + ", fromProjId=" + fromProjId + ", fromProjName="
				+ fromProjName + ", fromCustId=" + fromCustId + ", bcWinBidder=" + bcWinBidder + ", bcManPer="
				+ bcManPer + ", bcWinSfee=" + bcWinSfee + ", bcActionAmount=" + bcActionAmount
				+ ", busCostBudgetingList=" + busCostBudgetingList + ", busContractPaymentList="
				+ busContractPaymentList + ", busConQuotedPriceList=" + busConQuotedPriceList + "]";
	}
