...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bsSubmitList" checkbox="true" fitColumns="true" title="费用报销" sortName="createDate" actionUrl="bsSubmitController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="bsSubmitController.do?goUpdate" funname="detail" width="100%" height="100%"></t:dgToolBar>
   	<t:dgToolBar title="送审" icon="icon-edit"  url="bsSubmitController.do?doCheck" funname="doCheck" ></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
 <script type="text/javascript">
 	//自定义按钮-sql增强-送审
 	function doCheck(title,url,id){
