...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bsSubmitList" checkbox="true" fitColumns="true" title="费用报销" sortName="createDate" actionUrl="bsSubmitController.do?datagrid&bsstate=0" idField="id" fit="true" queryMode="group">
   ...
   <%-- <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar> --%>
   	<t:dgToolBar title="送审" icon="icon-edit"  url="bsSubmitController.do?doUnaudited" funname="doUnaudited" ></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
