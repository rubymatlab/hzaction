  ...
  <t:formvalid formid="formobj" dialog="true" beforeSubmit="judge" usePlugin="password" layout="table" tiptype="1" action="vmBusPoPayWmtController.do?doAdd" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="bpmName" name="bpmName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  onclick="popupClick(this,'bpm_name,bpm_proj_id,id','bpmName,bpmProjId,fromProjId','bus_project_manager')"/>			 
				<span class="Validform_checktip"></span>
