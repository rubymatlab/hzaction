  ...
  <t:formvalid formid="formobj" dialog="true" beforeSubmit="judge" usePlugin="password" layout="table" tiptype="1" action="vmBusPoPayWmtController.do?doAdd" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="bpmName" name="bpmName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  
					onclick="popupClick(this,'bpm_name,bpm_proj_id,id,from_projm_id','bpmName,bpmProjId,fromProjId,busPayInfoList[0].fromProjmId','bus_project_manager')"/>			 
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpManager" name="bpManager" type="text"  maxlength="32" style="width: 150px" class="inputxt"  
						ignore="ignore" value='${vmBusPoPayWmtPage.bpManager}'/>
				<span class="Validform_checktip"></span>
