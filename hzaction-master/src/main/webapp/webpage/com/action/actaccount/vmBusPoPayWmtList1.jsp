...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vmBusPoPayWmtList" checkbox="true" fitColumns="true" title="采购付款单" sortName="createDate" actionUrl="vmBusPoPayWmtController.do?datagrid&state=1" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="驳回" url="vmBusPoPayWmtController.do?doReturn&id={id}"  urlclass="ace_button" urlfont="fa-trash-o"/>
