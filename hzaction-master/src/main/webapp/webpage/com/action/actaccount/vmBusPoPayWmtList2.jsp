...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vmBusPoPayWmtList" checkbox="true" fitColumns="true" title="采购付款单" sortName="createDate" actionUrl="vmBusPoPayWmtController.do?datagrid&state=2" idField="id" fit="true" queryMode="group">
