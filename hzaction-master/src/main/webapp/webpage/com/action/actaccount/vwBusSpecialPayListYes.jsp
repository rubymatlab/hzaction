...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwBusSpecialPayList" checkbox="true" pagination="true" fitColumns="true" title="零星支出单" sortName="createDate" actionUrl="vwBusSpecialPayController.do?datagrid&bpmStatus=3" idField="id" fit="true" queryMode="group">
