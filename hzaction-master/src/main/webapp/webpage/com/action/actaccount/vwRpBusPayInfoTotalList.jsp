...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwRpBusPayInfoTotalList" checkbox="false" pagination="true" fitColumns="false" title="出纳日记账报表" sortName="id" actionUrl="vwRpBusPayInfoTotalController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="支付时间"  field="bpiPayDate"  formatter="yyyy-MM-dd"  query="true"  queryMode="group"  width="140"></t:dgCol>
...
<%--    <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="新建" icon="icon-add" url="vwRpBusPayInfoTotalController.do?goAdd" funname="add"></t:dgToolBar>
