...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwRpCostAccountList" checkbox="false" fitColumns="false" title="项目整体结算表" sortName="id" actionUrl="vwRpCostAccountController.do?datagrid" idField="id" fit="false" queryMode="group">
