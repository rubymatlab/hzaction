...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwRpCostAccountList" checkbox="false" fitColumns="false" title="项目整体结算表" sortName="id" actionUrl="vwRpCostAccountController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="立项时间"  field="bpDate"  formatter="yyyy-MM-dd"  query="true"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="客户名称"  field="bcName"  query="true"  queryMode="single"  width="180"></t:dgCol>
   ...
   <t:dgCol title="中标金额"  field="bcContAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="管理费"  field="projManAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="中标服务费"  field="bcWinSfee"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="中标方"  field="bcWinBidder"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="合同金额"  field="bcActionAmount"  queryMode="group"  width="80"></t:dgCol>
   ...
   <t:dgCol title="开票金额"  field="bcInvAmount"  queryMode="group"  width="80"></t:dgCol>
   ...
   <t:dgCol title="回款总额"  field="brpBackAmountD"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="应收金额"  field="receivableAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="未收占比"  field="notReceivablePer"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="采购应付"  field="poPayableTamount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="采购已付"  field="poPayTamount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="采购未付"  field="poNotPayTamount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="其他支出"  field="othersPayAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="支出合计"  field="projPayTotal"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="垫资金额"  field="padBranchAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="资金成本"  field="padBranchCost"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="现金毛利"  field="cashMarginAmount"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="应收毛利"  field="payableMarginAmount"  queryMode="group"  width="80"></t:dgCol>
 ...
 <%--  <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="导出" icon="icon-putout" url="vwRpCostAccountController.do?doCreatereport" funname="doCreatereport"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
