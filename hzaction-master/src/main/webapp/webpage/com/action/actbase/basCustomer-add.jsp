...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="basCustomerController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bcSname" name="bcSname" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bcBankId" name="bcBankId" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bcBankAcc" name="bcBankAcc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
