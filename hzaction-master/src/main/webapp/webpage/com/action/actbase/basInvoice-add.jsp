...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="basInvoiceController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="biCode" name="biCode" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="biAmount" name="biAmount" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="d" ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="biDate" name="biDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />    
							<span class="Validform_checktip"></span>
