...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="busPoContractController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
					  <input id="bpcPoDate" name="bpcPoDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore"  />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="bpExpPayDate" name="bpExpPayDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore"  />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpcRecTel" name="bpcRecTel" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpcRecAddr" name="bpcRecAddr" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
	...
	<tbody id="add_busPoApplyDetailCon_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
							<input name="busPoApplyDetailConList[#index#].createDate" type="text" class="Wdate" onClick="WdatePicker()"  style="width:150px;" ignore="ignore" />
				  ...
				  <td align="left">
							<input name="busPoApplyDetailConList[#index#].updateDate" type="text" class="Wdate" onClick="WdatePicker()"  style="width:150px;" ignore="ignore" />
	...
	<tbody id="add_busPoContractDetail_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="busPoContractDetailList[#index#].bpcdName" name="busPoContractDetailList[#index#].bpcdName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  onclick="popupClick(this,'bpad_name,bpad_brand,bpad_model,bpad_number','bpcdName,bpcdBrand,bpcdModel,bpcdNumber','rf_bus_po_apply_detail')"/>
