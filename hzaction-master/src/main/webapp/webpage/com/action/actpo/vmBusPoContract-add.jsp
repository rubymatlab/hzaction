...
<!-- 				<input type="hidden" id="bpmCustSName" name="bpmCustSName" ignore="ignore" class="inputxt"> -->
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<%-- <t:tab href="vmBusPoContractController.do?vmMergeBusPoApplyDetailList&id=${vmBusPoContractPage.id}" icon="icon-search" title="采购合同申请明细" id="vmMergeBusPoApplyDetail"></t:tab> --%>
	...
	<tbody id="add_busPoContractDetail_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="busPoContractDetailList[#index#].bpcdNumber" maxlength="32" type="text" datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">数量</label>
				  </td>
				  <td align="left">
					  	<input name="busPoContractDetailList[#index#].bpcdPrice" maxlength="32" type="text" datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  style="width:120px;"  ignore="ignore" />
				  ...
				  <td align="left">
				   ...
				   <td align="left">
			  			<input name="busPoContractDetailList[#index#].fromPoApplyDetId" maxlength="32" type="hidden" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">采购申请外键</label>
				  </td> 
			</tr>
		 </tbody>
