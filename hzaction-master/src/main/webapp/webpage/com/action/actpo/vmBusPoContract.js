...
$("#bpmProjName").dropDownSelect({
	url: "vmBusPoContractController/loadSuggestData.do?type=project&keyword="
})

$("#bsName").dropDownSelect({
	url: "vmBusPoContractController/loadSuggestData.do?type=supplier&keyword="
})
