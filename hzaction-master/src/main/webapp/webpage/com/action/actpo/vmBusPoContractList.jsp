...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vmBusPoContractList" checkbox="true" fitColumns="true" title="采购合同" sortName="createDate" actionUrl="vmBusPoContractController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="新建" icon="icon-add" url="vmBusPoContractController.do?goAdd" funname="add" width="100%" height="100%"></t:dgToolBar>
