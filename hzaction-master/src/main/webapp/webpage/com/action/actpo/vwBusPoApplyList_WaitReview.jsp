...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="vwBusPoApplyList" checkbox="true" fitColumns="true"
			...
			<t:dgToolBar title="审核完成" icon="icon-ok"
				url="vwBusPoApplyController.do?doBtn_shwc" funname="doBtn_shwc"></t:dgToolBar>
			<t:dgToolBar title="驳回" icon="icon-tip"
				url="vwBusPoApplyController.do?doBtn_SendBack" funname="doBtn_submit"></t:dgToolBar>
		</t:datagrid>
	</div>
</div>
<script src="webpage/com/action/actpo/dropdown.js">
$(function(){ 
	  var x=$("#vwBusPoApplyListForm input[name=bpmName]");
	x.addClass("easyui-combogrid").attr("data-options",
			"panelWidth: 500,"+ 
            "idField: 'id', "+ 
