...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="vmBusProjectManagerController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="bpmProjName" name="bpmProjName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpmCustName" name="bpmCustName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
	...
	<tbody id="add_vmBusCollectPlan_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
							<input name="vmBusCollectPlanList[#index#].brpExtBackDate" type="text" class="Wdate" onClick="WdatePicker()"  style="width:150px;" ignore="ignore" />
				  ...
				  <td align="left">
							<input name="vmBusCollectPlanList[#index#].brpInvoiceDate" type="text" class="Wdate" onClick="WdatePicker()"  style="width:150px;" ignore="ignore" />
	...
	<tbody id="add_busProjectFollow_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="busProjectFollowList[#index#].bpfFollowReport" maxlength="32" type="text" class="inputxt"  style="width:300px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">跟进情况汇报</label>
				  </td>
				  <td align="left">
					  	<input name="busProjectFollowList[#index#].bpfQuestions" maxlength="32" type="text" class="inputxt"  style="width:300px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">施工困难_问题</label>
				  </td>
				  <td align="left">
					  	<input name="busProjectFollowList[#index#].bpfNextPlan" maxlength="32" type="text" class="inputxt"  style="width:300px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">下一步计划</label>
				  </td>
				  <td align="left">
							<input name="busProjectFollowList[#index#].bpfCheckDate" type="text" class="Wdate" onClick="WdatePicker()"  style="width:150px;" ignore="ignore" />
