...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
             action="vmBusProjectManagerController.do?doUpdate">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value">
                <input id="bpmProjId" name="bpmProjId" type="text" maxlength="32" readonly="readonly" style="width: 60%"
                       class="inputxt" ignore="ignore" value='${vmBusProjectManagerPage.bpmProjId}'/>
            ...
            <td class="value">
                <input id="bpmProjName" name="bpmProjName" type="text" readonly="readonly" maxlength="32"
                       style="width: 60%" class="inputxt" ignore="ignore"
                       value='${vmBusProjectManagerPage.bpmProjName}'/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="bpmCustName" name="bpmCustName" type="text" readonly="readonly" maxlength="32"
                       style="width: 60%" class="inputxt" ignore="ignore"
                       value='${vmBusProjectManagerPage.bpmCustName}'/>
                <span class="Validform_checktip"></span>
            ...
            <td class="value">
                <t:dictSelect field="bpmProjProg" type="list" typeGroupCode="proj_prog"
                              defaultVal="${vmBusProjectManagerPage.bpmProjProg}" hasLabel="false"
                              title="项目进度"></t:dictSelect>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <t:dictSelect field="bpmProgPer" type="list" typeGroupCode="proj_per"
                              defaultVal="${vmBusProjectManagerPage.bpmProgPer}" hasLabel="false"
                              title="进度百分比"></t:dictSelect>
                <span class="Validform_checktip"></span>
    ...
    <div style="width: auto;height: 200px;">
        ...
        <t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
            <t:tab href="vmBusProjectManagerController.do?busProjectFollowList&id=${vmBusProjectManagerPage.id}"
                   icon="icon-search" title="项目跟进" id="busProjectFollow"></t:tab>
            <t:tab href="vmBusProjectManagerController.do?vmBusCollectPlanList&id=${vmBusProjectManagerPage.id}"
                   icon="icon-search" title="回款计划" id="vmBusCollectPlan"></t:tab>
...
<table style="display:none">
    ...
    <tr>
        ...
        <td align="left">
            <t:dictSelect field="vmBusCollectPlanList[#index#].brpProgressStages" type="list" typeGroupCode="gathering"
                          defaultVal="" hasLabel="false" title="进度款分期"></t:dictSelect>
            <label class="Validform_label" style="display: none;">进度款分期</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpContractAmount" maxlength="32" type="text" class="inputxt"
                   style="width:120px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">合同金额</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpExtBackDate" maxlength="0" type="text" class="Wdate"
                   onClick="WdatePicker()" style="width:150px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">预计回款日期</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpBackAmount" maxlength="32" type="text" class="inputxt"
                   style="width:120px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">回款金额</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpPlanInvoiceDate" maxlength="0" type="text" class="Wdate"
                   onClick="WdatePicker()" style="width:150px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">计划开票日期</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpAcceptAmount" maxlength="32" type="text" class="inputxt"
                   style="width:120px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">已收金额</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpIsInvoice" maxlength="32" type="text" class="inputxt"
                   style="width:120px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">发票金额</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpInvoiceDate" maxlength="0" type="text" class="Wdate"
                   onClick="WdatePicker()" style="width:150px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">开票日期</label>
        </td>
        <td align="left">
            <input name="vmBusCollectPlanList[#index#].brpRemark" maxlength="32" type="text" class="inputxt"
                   style="width:120px;" ignore="ignore"/>
    ...
    <tr>
        ...
        <td align="left">
            ...
            <input name="busProjectFollowList[#index#].bpfFollowDate" maxlength="0" type="text" class="Wdate"
                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width:150px;" ignore="ignore"/>
        ...
        <td align="left">
            <input name="busProjectFollowList[#index#].bpfCheckDate" maxlength="0" type="text" class="Wdate"
                   onClick="WdatePicker()" style="width:150px;" ignore="ignore"/>
            <label class="Validform_label" style="display: none;">计划验收时间</label>
        </td>
        <%--<td align="left">--%>
            <%--<t:dictSelect field="busProjectFollowList[#index#].bpfCheckResult" type="list" typeGroupCode="check_res"--%>
                          <%--defaultVal="" hasLabel="false" title="验收结果"></t:dictSelect>--%>
