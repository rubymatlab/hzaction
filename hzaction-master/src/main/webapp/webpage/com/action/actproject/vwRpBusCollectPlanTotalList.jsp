...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwRpBusCollectPlanTotalList" checkbox="false" pagination="true" fitColumns="true" title="回款计划汇总" sortName="id" actionUrl="vwRpBusCollectPlanTotalController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="项目名称"  field="bpmName"  queryMode="single"  width="120"></t:dgCol>
