...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwRpBusProgressInfoList" checkbox="true" pagination="true" fitColumns="true" title="施工进度报表" sortName="id" actionUrl="vwRpBusProgressInfoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="施工困难_问题"  field="bpfQuestions"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="下一步计划"  field="bpfNextPlan"  queryMode="group"  width="120"></t:dgCol>
...
<%--    <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="vwRpBusProgressInfoController.do?goAdd" funname="add"></t:dgToolBar>
