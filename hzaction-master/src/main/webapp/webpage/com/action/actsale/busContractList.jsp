...
<div class="easyui-layout" fit="true">
  ...
  <t:tabs id="tabsThree" iframe="false" tabPosition="top" fit="true">
	<t:tab iframe="busContractController.do?list0"  icon="icon-edit" title="未审核" id="tab1"></t:tab>
	<t:tab iframe="busContractController.do?list1" closable="true"  icon="icon-save" title="已审核" id="tab2"></t:tab>
  </t:tabs>
 </div>
 </div>
