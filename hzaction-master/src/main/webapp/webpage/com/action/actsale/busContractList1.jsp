...
<t:base type="jquery,easyui,tools,DatePicker"></t:base>
  ...
  <t:datagrid name="busContractList" checkbox="true" fitColumns="true" title="合同管理" sortName="createDate" actionUrl="busContractController.do?datagrid&contractState=2" idField="id" fit="true" queryMode="group">
   ...
   <%--<t:dgCol title="签订时间"  field="bcConcludeTime" hidden="true" formatter="yyyy-MM-dd"  query="true"  queryMode="group"  width="120"></t:dgCol>--%>   
...
<%--    <t:dgToolBar title="合同确定" icon="icon-save" url="busContractController.do?goUpdate" funname="update" width="100%" height="100%"></t:dgToolBar>
 --%>   
