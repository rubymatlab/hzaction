...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="busProjectController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="bpProjId" name="bpProjId" type="text" maxlength="40" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpProjId}'/>
			...
			<td class="value">
		     	 <input id="bpProjName" name="bpProjName" type="text" maxlength="200" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpProjName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="bpDate" name="bpDate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${busProjectPage.bpDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bpKeyPeople" name="bpKeyPeople" type="text" maxlength="20" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpKeyPeople}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpProSolutions" name="bpProSolutions" type="text" maxlength="500" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpProSolutions}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bpQuestions" name="bpQuestions" type="text" maxlength="500" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpQuestions}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpCompetition" name="bpCompetition" type="text" maxlength="500" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpCompetition}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bpManager" name="bpManager" type="text" maxlength="40" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpManager}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <t:dictSelect field="bpTeam" type="list"  typeGroupCode="bp_type"   defaultVal="${busProjectPage.bpTeam}" hasLabel="false"  title="项目阶段" ></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bpFollowResults" name="bpFollowResults" type="text" maxlength="20" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.bpFollowResults}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fromCustId" name="fromCustId" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${busProjectPage.fromCustId}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
                ...
                <textarea name="bpIntroduction" id="bpIntroduction" style="width: 650px;height:300px">${busProjectPage.bpIntroduction }</textarea>
				    <script type="text/javascript">
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="busProjectController.do?busProjectDisfollowList&id=${busProjectPage.id}" icon="icon-search" title="项目跟进情况" id="busProjectDisfollow"></t:tab>
				 ...
				 <t:tab href="busProjectController.do?busProjPartnerList&id=${busProjectPage.id}" icon="icon-search" title="合作伙伴资料" id="busProjPartner"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
		...
		<tbody id="add_busProjectDisfollow_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <!-- <td align="left">
					  		<input name="busProjectDisfollowList[#index#].bpdDisNo" datatype="n" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
				  ...
				  <td align="left">
				  		<input name="busProjectDisfollowList[#index#].bpdQuestions" maxlength="3000" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">问题or协助</label>
					</td>
				  <td align="left">
