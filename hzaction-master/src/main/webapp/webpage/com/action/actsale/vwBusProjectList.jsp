...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="vwBusProjectList" checkbox="true" fitColumns="true" title="项目立项视图" sortName="createDate" actionUrl="vwBusProjectController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="项目编号"  field="bpProId"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="项目名称"  field="bpProName"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="立项时间"  field="bpDate"  formatter="yyyy-MM-dd"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="项目关键人"  field="bpKeyPeople"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="项目简介"  field="bpIntroduction"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="正式挂网时间"  field="bpOnlineTime"  formatter="yyyy-MM-dd hh:mm:ss"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>
   	<t:dgToolBar title="立项转投标" icon="icon-edit"  url="vwBusProjectController.do?doBtnAccess" funname="doBtnAccess" ></t:dgToolBar>
   	<t:dgToolBar title="立项转合同" icon="icon-edit"  url="vwBusProjectController.do?doBtnAccessContent" funname="doBtnAccessContent" ></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
 <script type="text/javascript">
 	//自定义按钮-sql增强-立项转投标
 	function doBtnAccess(title,url,id){
 	...
 	//自定义按钮-sql增强-立项转合同
 	function doBtnAccessContent(title,url,id){
 		var rowData = $('#'+id).datagrid('getSelected');
		if (!rowData) {
			tip('请选择立项转合同项目');
			return;
